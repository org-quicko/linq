...
Follows `docs/plans/Plan_10.md`.

## Context

`docs/plans/Plan_1.md:60` settled the counting strategy as "SQL aggregates over
...
- `docs/adr/0001`, `0002`, `0003` keep their wording. They are dated records of
  decisions that have not changed, and `docs/plans/Plan_10.md:32` already set the
...
- `docs/adr/0007` — visit counts are rolled up by trigger. It reverses
  `docs/plans/Plan_1.md:60`; the consequence worth writing down is that the rollups are
