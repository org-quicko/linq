...
**Left untouched:** `docs/plans/Plan_1.md`…`Plan_7.md` (frozen historical records — same reasoning as not editing `docs/adr/0006`) and `docs/adr/0006` itself.
