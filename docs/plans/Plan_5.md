...
- **Docs**: rename across all docs including `docs/plans/Plan_1..4.md` and `docs/adr/*`.
...
`docs/plans/Plan_1..4.md` — rename entity tokens (glossary `Plan_1.md:13-28`, schema
...
Per the repo convention, this plan should also land as `docs/plans/Plan_5.md` before
