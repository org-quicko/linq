...
Follows `plans/Plan_31.md` §A4 and §C3, which built the Analytics overview
...
This plan builds that server-side filter. `plans/Plan_34.md` spends it.
...
them, and they go in `plans/Plan_34.md` once it no longer does. Two report
 ...
 *  See plans/Plan_33.md §A and docs/adr/0015. */
...
-- the visit log through a covering index. plans/Plan_33.md §A-§C,
-- docs/adr/0015.
...
`plans/Plan_34.md` moves them here when it deletes that file.
...
(`plans/Plan_32.md:370-392`). Verified again: repo-wide, `openapi` appears
