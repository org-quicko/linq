...
Follows `plans/Plan_27.md` (the restyle) and `plans/Plan_30.md` (the summary
...
**1. There is no QR code surface at all.** `plans/Plan_1.md:139` parked a
...
- **The archive confirm dialog stays** (`:288-315`). `plans/Plan_27.md` Part B3
...
- **`--accent` and `--chart-2`** (`globals.css:72`, `:80-84`) are left alone.
  ...
  deliberate human/bot contrast from `plans/Plan_30.md`.
